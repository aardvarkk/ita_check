...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { destination_dates: @query.destination_dates, destinations: @query.destinations, origin_dates: @query.origin_dates, origins: @query.origins }
    end
  ...
  test "should update query" do
    patch :update, id: @query, query: { destination_dates: @query.destination_dates, destinations: @query.destinations, origin_dates: @query.origin_dates, origins: @query.origins }
    assert_redirected_to query_path(assigns(:query))
  end
